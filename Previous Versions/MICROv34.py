...
class AltitudeEstimator:
    ...
    def update(self):
        ...
        # Fake force correction in free fall
        if acc_mag < free_fall_threshold:
            ...
            if net_acc_z > 0:
                self.velocity += net_acc_z * dt  # allow full upward influence
            elif net_acc_z < -0.1:
                self.velocity += net_acc_z * dt  # allow strong downward influence
